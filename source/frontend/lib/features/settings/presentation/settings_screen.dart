...
//
// SettingsScreen — Language, notification time, account, legal links.
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Center(
            child: Text('İçimden v1.0.0', style: AppTheme.labelSmall),
          ),
        ],
      ),
    );
  ...
  void _confirmDeleteAccount(BuildContext context, WidgetRef ref) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text(s.settingsDeleteAccount, style: AppTheme.headlineMedium),
        content: Text(
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(child: Text(S.of(context).settingsLanguage, style: AppTheme.titleMedium)),
                  Container(
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              Text(lang.$2, style: const TextStyle(fontSize: 24)),
                              const SizedBox(width: 14),
                              Expanded(
                                child: Text(lang.$3,
