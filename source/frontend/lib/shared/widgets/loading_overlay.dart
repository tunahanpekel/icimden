...
//
// Reusable loading, error, and empty state widgets for İçimden.
...
// ─── Message shimmer (for message screen loading) ──────────────────────────────
  ...
  Widget build(BuildContext context) {
    return Shimmer.fromColors(
      ...
      child: Column(
        ...
        children: [
          Container(height: 18, width: double.infinity, decoration: BoxDecoration(color: AppTheme.bgSurface, borderRadius: BorderRadius.circular(4))),
          const SizedBox(height: 12),
          Container(height: 18, width: double.infinity, decoration: BoxDecoration(color: AppTheme.bgSurface, borderRadius: BorderRadius.circular(4))),
          const SizedBox(height: 12),
          Container(height: 18, width: MediaQuery.of(context).size.width * 0.7, decoration: BoxDecoration(color: AppTheme.bgSurface, borderRadius: BorderRadius.circular(4))),
        ],
      ),
    );
  }
